...
const StartedBody = () => {
    return (
        <div className='flex gap-[48px] max-w-[1440px] px-[4rem]'>
            <div className='step1 flex flex-col items-center gap-[48px] w-[33.33%]'>
            ...
            <div className="step2 flex flex-col items-center gap-[48px] w-[33.33%]">
                <div className='img-container'>
            ...
            <div className='step3 flex flex-col items-center gap-[48px] w-[33.33%]'>
                <div className='img-container'>
