        ...
        <form method='post' noValidate>
            ...
            <div className='overflow-hidden relative block z-0 mx-[-1.6rem] px-[1.6rem] py-[12px] md:mx-[-0.8rem] md:px-[0.8rem]'>
                <div className='bg-[#fff] rounded-[8px] py-[12px] px-[16px] relative flex items-center' style={{transition: "border .2 linear .2", boxShadow: "0 0 0 1px rgba(0,0,0,.4)"}}>
                    <label htmlFor="starCode" className={selected ? "bg-[#fff] text-[#000000de] cursor-text text-[1.4rem] left-[12px] opacity-100 px-[0.4rem] absolute transform-y-[-50%] select-none z-[2] form-label md:text-[1.4rem] top-[-28%]" : "bg-[#fff] text-[#000000de] cursor-text text-[1.6rem] left-[12px] opacity-100 px-[0.4rem] absolute transform-y-[-50%] select-none z-[2] form-label md:text-[1.9rem]"}>
            ...
            <div className='pr-[1.6rem]'>
                <div className='h-auto form-warn-transition'>
                    <div className={selected ? "" : "hidden"}>
                        <span className='block pt-[0.4rem]'>
                            <span className='flex relative form-warn-color text-[1.3rem] md:text-[1.4rem]'>
                                <SimpleCross />
