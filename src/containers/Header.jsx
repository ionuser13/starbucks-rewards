...
const Header = () => {
    return (
        <header className='relative z-[2] upperHeader'>
            <div className='px-[1.6rem] md:px-[2.4rem] lg:px-[4rem] min-[1520px]:mx-[auto] min-[1520px]:max-w-[1440px] min-[1520px]:px-[0]'>
                <div className='flex items-center'>
                    <div className="mr-[1.6rem] my-[1.6rem] md:my-0 md:mr-[2.4rem] lg:mr-[4rem] w-[32px] h-[32px] min-[375px]:w-[40px] min-[375px]:h-[40px] md:w-[51px] md:h-[51px]">
                        <StarLogo />
                    </div>
