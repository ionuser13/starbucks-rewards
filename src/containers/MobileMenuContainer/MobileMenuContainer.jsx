...
const MobileMenuContainer = () => {
    return (
        <div className='bg-[#fff] block pt-[3.2rem] left-[20vw] overflow-auto fixed right-0 w-[80vw] bottom-auto top-[64px] h-[calc(100%-64px)] min-[375px]:h-[calc(100%-72px)] min-[375px]:top-[72px] md:h-[calc(100%-83px)] md:top-[100px]' style={{boxShadow: "inset 0 4px 3px -3px rgb(0 0 0 / 10%), inset 0 4px 2px -2px rgb(0 0 0 / 7%)",}}>
            <div>
                <MenuOptionsMobile />
